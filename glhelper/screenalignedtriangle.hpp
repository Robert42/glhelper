...
namespace gl
{
	...
	public:
		...
		ScreenAlignedTriangle(const Details::DefaultVec2<float>& min=Details::DefaultVec2<float>(-1, -1),
		                      const Details::DefaultVec2<float>& max=Details::DefaultVec2<float>(1, 1));
